...
class PengajuanAkreditasi(models.Model):
    ...
    GambarLaporanJadwalKegiatan = models.ImageField(
        upload_to=LaporanJadwalKegiatan, null=True, blank=True
    )
    TataTertib = models.CharField(max_length=50, choices=KEBUTUHAN_CHOICES)
    GambartataTertib = models.ImageField(upload_to=TataTertib, null=True, blank=True)
    LaporanKegiatanProgramKreatif = models.CharField(
        max_length=50, choices=KEBUTUHAN_CHOICES
    )
    GambarLaporanKegiatanProgramKreatif = models.ImageField(
        upload_to=LaporanKegiatanProgramKreatif, null=True, blank=True
    )
    LaporanHasilKaryaPrestasi = models.CharField(
        max_length=50, choices=KEBUTUHAN_CHOICES
    )
    GambarLaporanHasilKaryaPrestasi = models.ImageField(
        upload_to=LaporanHasilKaryaPrestasi, null=True, blank=True
    )
    BuktiKegiatanEkstrakulikuler = models.CharField(
        max_length=50, choices=KEBUTUHAN_CHOICES
    )
    GambarBuktiKegiatanEkstrakulikuler = models.ImageField(
        upload_to=BuktiKegiatanEkstrakulikuler, null=True, blank=True
    )
    BuktiKegiatanOsis = models.CharField(max_length=50, choices=KEBUTUHAN_CHOICES)
    GambarBuktiKegiatanOsis = models.ImageField(
        upload_to=BuktiKegiatanOsis, null=True, blank=True
    )
    BuktiKegiatanDenganPihakLuar = models.CharField(
        max_length=50, choices=KEBUTUHAN_CHOICES
    )
    GambarBuktiKegiatanDenganPihakLuar = models.ImageField(
        upload_to=BuktiKegiatanDenganPihakLuar, null=True, blank=True
    )
    ...
    GambarPortofolioTugasSiswa = models.ImageField(
        upload_to=PortofolioTugasSiswa, null=True, blank=True
    )
    PortofolioTugasMateriPengembangan = models.CharField(
        max_length=50, choices=KEBUTUHAN_CHOICES
    )
    GambarPortofolioTugasMateriPengembangan = models.ImageField(
        upload_to=PortofolioTugasMateriPengembangan, null=True, blank=True
    )
    LaporanPrestasiSiswaLomba = models.CharField(
        max_length=50, choices=KEBUTUHAN_CHOICES
    )
    GambarLaporanPrestasiSiswaLomba = models.ImageField(
        upload_to=LaporanPrestasiSiswaLomba, null=True, blank=True
    )
    DataNilaiUjian = models.CharField(max_length=50, choices=KEBUTUHAN_CHOICES)
    GambarDataNilaiUjian = models.ImageField(
        upload_to=DataNilaiUjian, null=True, blank=True
    )
    LaporanHasilTracerStudy = models.CharField(max_length=50, choices=KEBUTUHAN_CHOICES)
    GambarLaporanHasilTracerStudy = models.ImageField(
        upload_to=LaporanHasilTracerStudy, null=True, blank=True
    )
    ...
    # LaporanKegiatanProgramKreatif = models.CharField(max_length=50, choices=KEBUTUHAN_CHOICES)
    # GambarLaporanKegiatanProgramKreatif = models.ImageField(upload_to=LaporanKegiatanProgramKreatif, null=True, blank=True)
    GambarKomponenMutuLulusan = models.ImageField(
        upload_to=KomponenMutuLulusan, null=True, blank=True
    )
    ...
    GambarLembarKerjaSiswa = models.ImageField(
        upload_to=LembarKerjaSiswa, null=True, blank=True
    )
    KisiKisiSoalInstrumenHasilPenilaian = models.CharField(
        max_length=50, choices=KEBUTUHAN_CHOICES
    )
    GambarKisiKisiSoalInstrumenHasilPenilaian = models.ImageField(
        upload_to=KisiKisiSoalInstrumenHasilPenilaian, null=True, blank=True
    )
    AnalisisPencapaianKompetensi = models.CharField(
        max_length=50, choices=KEBUTUHAN_CHOICES
    )
    GambarAnalisisPencapaianKompetensi = models.ImageField(
        upload_to=AnalisisPencapaianKompetensi, null=True, blank=True
    )
    JadwalRemedial = models.CharField(max_length=50, choices=KEBUTUHAN_CHOICES)
    GambarJadwalRemedial = models.ImageField(
        upload_to=JadwalRemedial, null=True, blank=True
    )
    ...
    GambarDaftarPenggunaanSapras = models.ImageField(
        upload_to=DaftarPenggunaanSapras, null=True, blank=True
    )
    ...
    # TataTertib = models.CharField(max_length=50, choices=KEBUTUHAN_CHOICES)
    # GambarTataTertib = models.ImageField(upload_to=TataTertib, null=True, blank=True)
    GambarKomponenProsesPembelajaran = models.ImageField(
        upload_to=KomponenProsesPembelajaran, null=True, blank=True
    )
    ...
    GambarLaporanEvaluasi = models.ImageField(
        upload_to=LaporanEvaluasi, null=True, blank=True
    )
    LaporanDariSiswa = models.CharField(max_length=50, choices=KEBUTUHAN_CHOICES)
    GambarLaporanDariSiswa = models.ImageField(
        upload_to=LaporanDariSiswa, null=True, blank=True
    )
    LaporanDariGuru = models.CharField(max_length=50, choices=KEBUTUHAN_CHOICES)
    GambarLaporanDariGuru = models.ImageField(
        upload_to=LaporanDariGuru, null=True, blank=True
    )
    BuktiDaftarHadir = models.CharField(max_length=50, choices=KEBUTUHAN_CHOICES)
    GambarBuktiDaftarHadir = models.ImageField(
        upload_to=BuktiDaftarHadir, null=True, blank=True
    )
    LaporanPengembanganGuru = models.CharField(max_length=50, choices=KEBUTUHAN_CHOICES)
    GambarLaporanPengembanganGuru = models.ImageField(
        upload_to=LaporanPengembanganGuru, null=True, blank=True
    )
    LaporanKegiatanDiseminasi = models.CharField(
        max_length=50, choices=KEBUTUHAN_CHOICES
    )
    GambarLaporanKegiatanDiseminasi = models.ImageField(
        upload_to=LaporanKegiatanDiseminasi, null=True, blank=True
    )
    # RPP = models.CharField(max_length=50, choices=KEBUTUHAN_CHOICES)
    # GambarRPP = models.ImageField(upload_to=RPP, null=True, blank=True)
    GambarKomponenMutuGuru = models.ImageField(
        upload_to=KomponenMutuGuru, null=True, blank=True
    )
    KomponenMutuGuru = models.IntegerField(null=True, blank=True)

    # Komponen Manajemen Sekolah
    DaftarHadirRapatVisiMisi = models.CharField(
        max_length=50, choices=KEBUTUHAN_CHOICES
    )
    GambarDaftarHadirRapatVisiMisi = models.ImageField(
        upload_to=DaftarHadirRapatVisiMisi, null=True, blank=True
    )
    LaporanKegiatanImplementasiVisiMisi = models.CharField(
        max_length=50, choices=KEBUTUHAN_CHOICES
    )
    GambarLaporanKegiatanImplementasiVisiMisi = models.ImageField(
        upload_to=LaporanKegiatanImplementasiVisiMisi, null=True, blank=True
    )
    DokumenHasilEvaluasi = models.CharField(max_length=50, choices=KEBUTUHAN_CHOICES)
    GambarDokumenHasilEvaluasi = models.ImageField(
        upload_to=DokumenHasilEvaluasi, null=True, blank=True
    )
    DokumenRekomendasi = models.CharField(max_length=50, choices=KEBUTUHAN_CHOICES)
    GambarDokumenRekomendasi = models.ImageField(
        upload_to=DokumenRekomendasi, null=True, blank=True
    )
    DokumenVisiMisiSebelumnyaDanSetelah = models.CharField(
        max_length=50, choices=KEBUTUHAN_CHOICES
    )
    GambarDokumenVisiMisiSebelumnyaDanSetelah = models.ImageField(
        upload_to=DokumenVisiMisiSebelumnyaDanSetelah, null=True, blank=True
    )
    JadwalSupervisi = models.CharField(max_length=50, choices=KEBUTUHAN_CHOICES)
    GambarJadwalSupervisi = models.ImageField(
        upload_to=JadwalSupervisi, null=True, blank=True
    )
    DokumenHasilObservasiKepsek = models.CharField(
        max_length=50, choices=KEBUTUHAN_CHOICES
    )
    GambarDokumenHasilObservasiKepsek = models.ImageField(
        upload_to=DokumenHasilObservasiKepsek, null=True, blank=True
    )
    DaftarHadirRapatRKSRKASdanNotulen = models.CharField(
        max_length=50, choices=KEBUTUHAN_CHOICES
    )
    GambarDaftarHadirRapatRKSRKASdanNotulen = models.ImageField(
        upload_to=DaftarHadirRapatRKSRKASdanNotulen, null=True, blank=True
    )
    LaporanKegiatanPelaksanaanProgram = models.CharField(
        max_length=50, choices=KEBUTUHAN_CHOICES
    )
    GambarLaporanKegiatanPelaksanaanProgram = models.ImageField(
        upload_to=LaporanKegiatanPelaksanaanProgram, null=True, blank=True
    )
    DokumenKerjaSama = models.CharField(max_length=50, choices=KEBUTUHAN_CHOICES)
    GambarDokumenKerjaSama = models.ImageField(
        upload_to=DokumenKerjaSama, null=True, blank=True
    )
    DokumenPelaksanaanKegiatanKebersihan = models.CharField(
        max_length=50, choices=KEBUTUHAN_CHOICES
    )
    GambarDokumenPelaksanaanKegiatanKebersihan = models.ImageField(
        upload_to=DokumenPelaksanaanKegiatanKebersihan, null=True, blank=True
    )
    DokumenRKAS1Tahun = models.CharField(max_length=50, choices=KEBUTUHAN_CHOICES)
    GambarDokumenRKAS1Tahun = models.ImageField(
        upload_to=DokumenRKAS1Tahun, null=True, blank=True
    )
    DokumenRKAS4Tahun = models.CharField(max_length=50, choices=KEBUTUHAN_CHOICES)
    GambarDokumenRKAS4Tahun = models.ImageField(
        upload_to=DokumenRKAS4Tahun, null=True, blank=True
    )
    DaftarHadirRapatRKSRKASdanNotulen = models.CharField(
        max_length=50, choices=KEBUTUHAN_CHOICES
    )
    ...
    GambarNotulenRakerKurikulum = models.ImageField(
        upload_to=NotulenRakerKurikulum, null=True, blank=True
    )
    DokumenRakerEvaluasiKurikulum = models.CharField(
        max_length=50, choices=KEBUTUHAN_CHOICES
    )
    GambarDokumenRakerEvaluasiKurikulum = models.ImageField(
        upload_to=DokumenRakerEvaluasiKurikulum, null=True, blank=True
    )
    SOPPelaksanaanTugasGuru = models.CharField(max_length=50, choices=KEBUTUHAN_CHOICES)
    GambarSOPPelaksanaanTugasGuru = models.ImageField(
        upload_to=SOPPelaksanaanTugasGuru, null=True, blank=True
    )
    JadwalMengajarGuru = models.CharField(max_length=50, choices=KEBUTUHAN_CHOICES)
    GambarJadwalMengajarGuru = models.ImageField(
        upload_to=JadwalMengajarGuru, null=True, blank=True
    )
    DokumenPenilaianKriteriaGuru = models.CharField(
        max_length=50, choices=KEBUTUHAN_CHOICES
    )
    GambarDokumenPenilaianKriteriaGuru = models.ImageField(
        upload_to=DokumenPenilaianKriteriaGuru, null=True, blank=True
    )
    HasilPenilaianKinerjaGuru = models.CharField(
        max_length=50, choices=KEBUTUHAN_CHOICES
    )
    GambarHasilPenilaianKinerjaGuru = models.ImageField(
        upload_to=HasilPenilaianKinerjaGuru, null=True, blank=True
    )
    DokumenPenilaianKinerjaTendik = models.CharField(
        max_length=50, choices=KEBUTUHAN_CHOICES
    )
    GambarDokumenPenilaianKinerjaTendik = models.ImageField(
        upload_to=DokumenPenilaianKinerjaTendik, null=True, blank=True
    )
    HasilPenilaianKinerjaTendik = models.CharField(
        max_length=50, choices=KEBUTUHAN_CHOICES
    )
    GambarHasilPenilaianKinerjaTendik = models.ImageField(
        upload_to=HasilPenilaianKinerjaTendik, null=True, blank=True
    )
    BuktiSaksiAtauPenghargaan = models.CharField(
        max_length=50, choices=KEBUTUHAN_CHOICES
    )
    GambarBuktiSaksiAtauPenghargaan = models.ImageField(
        upload_to=BuktiSaksiAtauPenghargaan, null=True, blank=True
    )
    SOPPengelolaanSapras = models.CharField(max_length=50, choices=KEBUTUHAN_CHOICES)
    GambarSOPPengelolaanSapras = models.ImageField(
        upload_to=SOPPengelolaanSapras, null=True, blank=True
    )
    DokumenRapatPenyususanRAPBS = models.CharField(
        max_length=50, choices=KEBUTUHAN_CHOICES
    )
    GambarDokumenRapatPenyususanRAPBS = models.ImageField(
        upload_to=DokumenRapatPenyususanRAPBS, null=True, blank=True
    )
    ...
    LaporanKeuangan1TahunTerakhir = models.CharField(
        max_length=50, choices=KEBUTUHAN_CHOICES
    )
    GambarLaporanKeuangan1TahunTerakhir = models.ImageField(
        upload_to=LaporanKeuangan1TahunTerakhir, null=True, blank=True
    )
    HasilCatatanAuditInternelEksternal3TahunTerakhir = models.CharField(
        max_length=50, choices=KEBUTUHAN_CHOICES
    )
    GambarHasilCatatanAuditInternelEksternal3TahunTerakhir = models.ImageField(
        upload_to=HasilCatatanAuditInternelEksternal3TahunTerakhir,
        null=True,
        blank=True,
    )
    DokumenProgramEkstrakulikuler = models.CharField(
        max_length=50, choices=KEBUTUHAN_CHOICES
    )
    GambarDokumenProgramEkstrakulikuler = models.ImageField(
        upload_to=DokumenProgramEkstrakulikuler, null=True, blank=True
    )
    SuratTugasPembinaDanTimLomba = models.CharField(
        max_length=50, choices=KEBUTUHAN_CHOICES
    )
    GambarSuratTugasPembinaDanTimLomba = models.ImageField(
        upload_to=SuratTugasPembinaDanTimLomba, null=True, blank=True
    )
    SertifikatPrestasi = models.CharField(max_length=50, choices=KEBUTUHAN_CHOICES)
    GambarSertifikatPrestasi = models.ImageField(
        upload_to=SertifikatPrestasi, null=True, blank=True
    )
    DokumenProgramLayananBK = models.CharField(max_length=50, choices=KEBUTUHAN_CHOICES)
    GambarDokumenProgramLayananBK = models.ImageField(
        upload_to=DokumenProgramLayananBK, null=True, blank=True
    )
    DokumenRKATahunSebelumnya = models.CharField(
        max_length=50, choices=KEBUTUHAN_CHOICES
    )
    GambarDokumenRKATahunSebelumnya = models.ImageField(
        upload_to=DokumenRKATahunSebelumnya, null=True, blank=True
    )
    DokumenEvaluasiDiriTahunSebelumnya = models.CharField(
        max_length=50, choices=KEBUTUHAN_CHOICES
    )
    GambarDokumenEvaluasiDiriTahunSebelumnya = models.ImageField(
        upload_to=DokumenEvaluasiDiriTahunSebelumnya, null=True, blank=True
    )
    GambarKomponenManajemenSekolah = models.ImageField(
        upload_to=KomponenManajemenSekolah, null=True, blank=True
    )
